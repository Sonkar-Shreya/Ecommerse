...
function Navbar() {
    return (
        <div className="fixed top-0 bg-slate-200 h-20 border-2 border-slate-400 flex items-center justify-between  w-full px-5">
            ...
            <div>
                <Link to={'/cart'} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full m-5">Cart</Link>
                <Link to={'/login'}>
